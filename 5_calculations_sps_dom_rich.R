...
# No. 'dom_cnt' have slightly higher number of rows as 'sum_u2'
print(dom_cnt)
print (sum_u2)
...
# THe most abundant species at plot D5 is Chojnacky_Code 23. 
...
# Question 7: How many trees are there at plot A5? 24 trees
# Question 8: How many different tree species are there at plot D1? 5 species
